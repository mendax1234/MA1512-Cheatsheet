...
\begin{enumerate}
    ...
    \begin{itemize}
        \item (\textbf{Forward}) Find $u(t-c)$, then use $\mathcal{L}[f(t)u(t-c)]=e^{-sc}\mathcal{L}[f(t+c)]$. Then $t\rightarrow t+c$. Lastly, use linearity and other properties to find the corresponding Laplace Transform $\mathcal{L}[f(t+c)]$.
